...
#define NO_IO_AUTO_RUN // if enabled the firmware will keep going, if commented the firmware should
                       // stop after all output matrixes are filled.
...
#define NO_IO_PERIODIC_TOT_STEPS \
    7 //(NO_IO_NUMBER_OF_COMMANDS * NO_IO_UI_STEPS * 2) //todo: this 2 =
// TASKS_OS_PERIODICITY_MUL_FACTOR
#define NO_IO_PERIODIC_STEPS_WAIT 0 // 200

//
#define NO_IO_UI_STEPS_WAIT \
    0 //(NO_IO_PERIODIC_TOT_STEPS * NO_IO_PERIODIC_STEPS_WAIT / NO_IO_NUMBER_OF_COMMANDS / 2)
...
// The temperature measured by the sensor and received by the fimware. One temp for each core for
// each step
...
// The actual recorded total power consumed by the model - If you do not have the data just put 0,
// it should be fine for now
extern varValue no_io_simPower[NO_IO_PERIODIC_TOT_STEPS]; //[NO_IO_NUMBER_OF_COMMANDS *
// NO_IO_UI_STEPS]; //Insert here!
