...
struct ctrl_config_param {
    ...
    // TBC: Since our implementation of the PID, maybe is better to not make this definable, but to
    // FORCE it active.
    ...
    varBool_e use_frequency_reduction_map; // to collect the information on the Frequency Reduction
                                           // causes
};
