...
/* Test */
    ...
    for (varFor task = 0; task < NUM_PERIODIC_TASKS; task++) {
        ...
        {
            task_period_counter_ISR[task] =
                (varShortCounter)g_TaskConfigTable.tasks_tap_multiplier[task];
...
/* To Print the System Clock */
    ...
    printf("Number of Cores: %d,\n\rSystem Clock: %u Hz\n\r", g_config_sys.num_cores,
           DEFAULT_SYSTEM_CLOCK); // TODO: put here SystemCoreClock, instead of my definition
#endif
...
// JO_TBR
    ...
    /** Timer ISR set up **/
    if (bTargetSetTimer(g_TaskConfigTable.tap_period_us) !=
        PCF_TRUE) // Timer value to be compared here.
    {
        // TODO: something
        vTargetPcfExit(-2);
    }
