...
void vTestTask(void *parameters) {
    ...
    const varValue ts27_core[27] = {
        2.74495712, 2.7491008,  2.75272832, 2.7573904,  2.763096,   2.76985504, 2.77768096,
        2.7865904,  2.79660096, 2.80773472, 2.82001504, 2.8334704,  2.84813056, 2.86402912,
        2.88120384, 2.899696,   2.91954976, 2.94081472, 2.96354592, 2.98780096, 3.0136448,
        3.0411472,  3.0703856,  3.10144256, 3.13440992, 3.16938688, 3.2064816};
    const varValue ts36_core[36] = {
        2.59944384, 2.60449744, 2.60793664, 2.61235072, 2.6177488,  2.62414,
        2.63153808, 2.63995808, 2.64941808, 2.6599384,  2.6715424,  2.68425648,
        2.69810976, 2.7131344,  2.72936544, 2.74684384, 2.7656112,  2.78571424,
        2.80720576, 2.83014048, 2.8545808,  2.880592,   2.908248,   2.93762688,
        2.968816,   3.00190912, 3.03700864, 3.0742288,  3.1136912,  3.15553216,
        3.19989952, 3.24695584, 3.2968816,  3.34987456, 3.40615424, 3.46596352};
...
#ifndef GSL_PARALLEL
        mnewt(max_iterations, x_init, num_core, min_residual_value, min_residual_value, &func_param,
              usrfunc);
#else
